...
class Text(JupyterMixin):
    ...
    def on(self, meta: Optional[Dict[str, Any]] = None, **handlers: Any) -> "Text":
      ...
      Example:
          ...
          >>> html_text = Text("hello world")
          >>> html_text.on(click="view.toggle('world')")
...
if __name__ == "__main__":  # pragma: no cover
    ...
    html_text.highlight_words(["Lorem"], "bold")
    html_text.highlight_words(["ipsum"], "italic")

    console = Console()

    console.rule("justify='left'")
    console.print(html_text, style="red")
    console.print()

    console.rule("justify='center'")
    console.print(html_text, style="green", justify="center")
    console.print()

    console.rule("justify='right'")
    console.print(html_text, style="blue", justify="right")
    console.print()

    console.rule("justify='full'")
    console.print(html_text, style="magenta", justify="full")
    console.print()
